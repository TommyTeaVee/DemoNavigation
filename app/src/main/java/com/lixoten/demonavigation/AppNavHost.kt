    ...
    NavHost(
        ...
        composable(route = AppDestinations.ScreenFour.name) {
            ScreenFour(
                ...
                onNextButtonClicked = {
                    navController.navigate(AppDestinations.ScreenFive.name)
                }
            )
        }
        composable(route= AppDestinations.ScreenFive.name){
            ScreenFive(
                onCancelButtonClicked = { cancelAndNavigateToStart(navController) },
                onNextButtonClicked = {
